...
flickrAPIKey = "5251a3c15783dc6d5fcc1d3228863717"  # API key
flickrSecret = "a1d50d5a9102a218"                  # shared "secret"
...
for current_tag in range(0, num_queries):
    ...
    out_file = open('/Users/Sam/Desktop/3rd-Semester/Applied-Data-Analytics/Flicks_project/scraped_images/Flickr_code_2009_05_14/query_imgs/images' + pos_queries[current_tag] + '.txt','w')
    ###########################################################################
